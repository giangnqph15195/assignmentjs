  ...
  <div class="my-5 flex lg:mt-0 lg:ml-4">
    ...
    <span class="sm:ml-3">
      <button type="button" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
        ...
        <a href="/admin/category">Trở Về</a>
      </button>
    </span>
    <!-- Dropdown -->
  </div>
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      ...
      <div class="px-4 py-6 sm:px-0">
        ...
        <form id="form-post" class="pl-20">
            <div class="my-5">
                <label><span class="font-bold">Name Category</span></label><br>
                <input id="namect" class="border-2 border-slate-900 w-96 h-10" type="text" value="">
            </div>
            <div class="my-5">
      ...
      imgPost.addEventListener("change", (e) => {
        ...
        axios({
          ...
          formAdd.addEventListener("submit", (e) => {
            ...
            console.log(formAdd);
            update({
                namect: document.querySelector("#namect"),
