      ...
      <div class="px-4 py-6 sm:px-0">
        ...
        <form id="form-add-pd" class="pl-20">
            ...
            <div class="my-5">
                ...
                <input id="img-pd" class="" type="file" value="">
            </div>
            <div class="my-5">
                <label><span class="font-bold">Price</span></label><br> 
                <input id="price" class="border-2 border-slate-900 w-96 h-10" type="text" value="">
            </div>
            <div class="my-5">
                <label><span class="font-bold">Detail</span></label><br> 
                <input id="detail" class="border-2 border-slate-900 w-96 h-10" type="text" value="">
            </div>
